...
def _vec_sum(vec_list):
     return np.array(vec_list).sum(0).tolist()
...
def helix_orientation(selection, visualize=1, sigma_cutoff=1.5, quiet=1):
    '''
DESCRIPTION
...
def angle_between_helices(selection1, selection2, method='helix_orientation', visualize=1, quiet=1):
    '''
DESCRIPTION
